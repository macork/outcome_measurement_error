out_me <- function(A0, A1, X0, X1, Y0, Y1_me, Y1_true, 
  ...
  ## spline method
  out0 <- spl_ipw(a = A0, psi = psi0, a.vals = a.vals, int.mat = int.mat, df = 6, se.fit = TRUE)
  out1 <- spl_ipw(a = A1, psi = psi1, a.vals = a.vals, int.mat = int.mat, df = 6, se.fit = TRUE)
